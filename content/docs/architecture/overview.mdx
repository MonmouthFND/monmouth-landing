...
- **BFT Simplex Consensus**: Single-slot finality with Byzantine fault tolerance. No probabilistic finality — a transaction is final in ~250ms.
...
9. Transaction is finalized in ~250ms
```
